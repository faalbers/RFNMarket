...
class Tickers():
    ...
    @property
    def dividends(self):
        self.dbEntries.add((database.TimeSeries, database.TimeSeries.getDividends, 'dividends'))

    @property
    def splits(self):
        self.dbEntries.add((database.TimeSeries, database.TimeSeries.getSplits, 'splits'))
    
    @property
    def prices(self):
        self.dbEntries.add((database.TimeSeries, database.TimeSeries.getPrices, 'prices'))
    
    @property
    def volumes(self):
        self.dbEntries.add((database.TimeSeries, database.TimeSeries.getVolumes, 'volumes'))
    ...
    @property
    def profile(self):
        self.dbEntries.add((database.Profiles, database.Profiles.getProfiles, 'profile'))
